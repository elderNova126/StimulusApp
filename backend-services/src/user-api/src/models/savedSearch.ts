...
export const SavedSearchUnion = createUnionType({
  name: 'SavedSearchUnion',
  types: () => [SavedSearch, ErrorResponse],
  resolveType(value) {
    if (value?.error) {
...
export const SavedSearchResponseUnion = createUnionType({
  name: 'SavedSearchResponseUnion',
  types: () => [SavedSearchResponse, ErrorResponse],
  resolveType(value) {
    if (value?.error) {
      return ErrorResponse;
    }
