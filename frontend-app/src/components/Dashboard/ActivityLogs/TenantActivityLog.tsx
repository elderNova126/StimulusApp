...
import NoResultsTenantActivity from '../NoResults/NoResultsTenantActivity';
const TenantActivityLog = (props: { events: EventLog[]; loading: boolean }) => {
  ...
  return (
    <Stack w="705px" border="1px solid #E4E4E4" h="365px" rounded="4px">
      <Stack isInline>
        <Text mt="13px" ml="23px" mr="475px" fontSize="16px" fontWeight="600">
          {t('Team Activity')}
        </Text>
        <Stack>
          <Menu closeOnSelect={false}>
            ...
            <MenuList overflow="scroll" maxHeight="50vh" border="1px solid #E4E4E4">
              <MenuItem
                icon={
                  <SwitchButton
      ...
      {events.length ? (
        ...
        <NoResultsTenantActivity />
      )}
    </Stack>
  );
};

export default TenantActivityLog;
